...
<body>
<hr />
<p> I am not quite sure how to turn the upload feature off for everyone </p>
...
echo $endpoint . "\n";
    ...
    $mysqlUserName      = "masterawsuser";
    $mysqlPassword      = "masteruserpassword";
    $mysqlHostName      = $endpoint;
    $DbName             = "controller";
